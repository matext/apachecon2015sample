...
public class Sentence extends Annotation {
  ...
  */  
  ...
  public float getSentiment() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_sentiment == null)
      jcasType.jcas.throwFeatMissing("sentiment", "apachecon.example.es.types.Sentence");
    return jcasType.ll_cas.ll_getFloatValue(addr, ((Sentence_Type)jcasType).casFeatCode_sentiment);}
    
  /** setter for sentiment - sets  
   * @generated
   * @param v value to set into the feature 
   */
  public void setSentiment(float v) {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_sentiment == null)
      jcasType.jcas.throwFeatMissing("sentiment", "apachecon.example.es.types.Sentence");
    jcasType.ll_cas.ll_setFloatValue(addr, ((Sentence_Type)jcasType).casFeatCode_sentiment, v);}    
  ...
  public String getText() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "apachecon.example.es.types.Sentence");
